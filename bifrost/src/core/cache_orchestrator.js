    ...
    class CacheOrchestrator {
        ...
        async init() {
            ...
            try {
                ...
                this.session.addListener((event, data) => {
        ...
        async _createSystemCache() {
            ...
            return {
                ...
                async remove(key) { return this.data.delete(key); },
                async clear() { this.data.clear(); },
                async getStats() { return { size: this.data.size, limit: LRU_LIMITS.system }; }
            };
        }
        ...
        async _createPinnedCache() {
            ...
            return {
                ...
                async remove(key) { return this.data.delete(key); },
                async clear() { this.data.clear(); },
                async getStats() { return { size: this.data.size, limit: null }; }
            };
        }
        ...
        async _createPluginCache() {
            ...
            return {
                ...
                async remove(key) { return this.data.delete(key); },
                async clear() { this.data.clear(); },
                async getStats() { return { size: this.data.size, limit: LRU_LIMITS.plugin }; }
            };
        }
        ...
        async _createRenderedCache() {
            ...
            return {
                ...
                async remove(key) { return this.data.delete(key); },
                async clear() { this.data.clear(); },
                async getStats() { return { size: this.data.size, limit: LRU_LIMITS.rendered }; }
            };
        }
    }
