...
**Note on editing zMachine values:**Editable zMachine values (tool preferences and resource limits) can be modified in three ways:
...
**The problem it solves:**Instead of hardcoding requirements like "needs 8GB RAM" directly in your code, you define them in a `.zEnv` file. The app then:
