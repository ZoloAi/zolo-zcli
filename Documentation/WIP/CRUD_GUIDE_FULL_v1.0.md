...
- **[VALIDATION_GUIDE.md](Extras/VALIDATION_GUIDE.md)** - Detailed validation rules
- **[JOIN_GUIDE.md](Extras/JOIN_GUIDE.md)** - Advanced JOIN patterns
- **[ON_DELETE_GUIDE.md](Extras/ON_DELETE_GUIDE.md)** - Cascade delete behavior
