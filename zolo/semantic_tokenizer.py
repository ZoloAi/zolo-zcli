...
TOKEN_TYPE_MAP = {
    ...
    TokenType.TYPE_HINT: 3,
    TokenType.NUMBER: 4,
    TokenType.STRING: 5,
    TokenType.BOOLEAN: 6,
    TokenType.NULL: 7,
    TokenType.BRACKET_STRUCTURAL: 8,
    TokenType.BRACE_STRUCTURAL: 9,
    TokenType.STRING_BRACKET: 10,
    TokenType.STRING_BRACE: 11,
    TokenType.COLON: 12,
    TokenType.COMMA: 13,
    TokenType.ESCAPE_SEQUENCE: 14,
    TokenType.VERSION_STRING: 15,
    TokenType.TIMESTAMP_STRING: 16,
    TokenType.TIME_STRING: 17,
    TokenType.RATIO_STRING: 18,
}
