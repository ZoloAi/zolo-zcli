...
from zolo.lsp_types import SemanticToken, TokenType
...
TOKEN_TYPE_MAP = {
    ...
    TokenType.BIFROST_KEY: 4,
    TokenType.UI_ELEMENT_KEY: 5,
    TokenType.ZCONFIG_KEY: 6,
    TokenType.ZRBAC_KEY: 7,
    TokenType.ZRBAC_OPTION_KEY: 8,
    TokenType.TYPE_HINT: 9,
    TokenType.NUMBER: 10,
    TokenType.STRING: 11,
    TokenType.BOOLEAN: 12,
    TokenType.NULL: 13,
    TokenType.BRACKET_STRUCTURAL: 14,
    TokenType.BRACE_STRUCTURAL: 15,
    TokenType.STRING_BRACKET: 16,
    TokenType.STRING_BRACE: 17,
    TokenType.COLON: 18,
    TokenType.COMMA: 19,
    TokenType.ESCAPE_SEQUENCE: 20,
    TokenType.VERSION_STRING: 21,
    TokenType.TIMESTAMP_STRING: 22,
    TokenType.TIME_STRING: 23,
    TokenType.RATIO_STRING: 24,
