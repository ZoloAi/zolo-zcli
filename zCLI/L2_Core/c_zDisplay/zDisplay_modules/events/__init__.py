...
1. Direct Import (Advanced Use):
    ```python
    from zCLI.L2_Core.c_zDisplay.zDisplay_modules.events import display_event_outputs
    from zCLI.L2_Core.c_zDisplay.zDisplay_modules.events import display_event_signals
