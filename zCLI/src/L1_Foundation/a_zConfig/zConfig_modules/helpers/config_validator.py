...
_VALID_MODES = ["Terminal", "zBifrost"]
...
_ERROR_PORT_CONFLICT = "Port conflict: websocket and http_server both configured to use port {port}. They must use different ports."
