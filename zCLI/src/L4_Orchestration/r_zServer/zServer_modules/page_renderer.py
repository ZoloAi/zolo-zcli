...
class PageRenderer:
    ...
    def __init__(self, zcli: Any, routes: Dict = None):
        ...
        Args:
            zcli: zKernel instance providing loader, session, display
...
<head>
    ...
    <title>{title} - zKernel Dynamic Web</title>
    <link rel="stylesheet" href="/style.css">
</head>
<body>
    <div class="container">
        <header>
            <h1>🎨 zKernel Dynamic Web</h1>
        ...
        <footer>
            <p>Generated by zKernel v1.5.4 - Demo 4: Dynamic Web UI</p>
        </footer>
    </div>
