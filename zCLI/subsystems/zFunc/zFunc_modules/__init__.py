...
**Standard Import Pattern**:
    >>> from zCLI.subsystems.zFunc.zFunc_modules import parse_arguments, resolve_callable
...
**External Usage** (from other subsystems):
    >>> from zCLI.subsystems.zFunc.zFunc_modules.func_args import parse_arguments
...
Example 1: Standard import and usage
    >>> from zCLI.subsystems.zFunc.zFunc_modules import parse_arguments, split_arguments
    >>> import logging
    >>> 
...
Example 2: Using resolve_callable standalone
    >>> from zCLI.subsystems.zFunc.zFunc_modules import resolve_callable
    >>> import logging
    >>> 
    >>> logger = logging.getLogger(__name__)
