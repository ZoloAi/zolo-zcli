...
-------------
Using parsers:
    >>> from zCLI.subsystems.zData.zData_modules.shared import parse_where_clause, parse_value
...
Using DataOperations facade:
    >>> from zCLI.subsystems.zData.zData_modules.shared import DataOperations
