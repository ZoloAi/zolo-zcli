...
Plugins can register custom adapters using `register_custom_adapter()`:
    ...
    from zCLI.subsystems.zData.zData_modules.shared.backends.adapter_registry import register_custom_adapter
...
Built-in adapters (auto-registered):
    ...
    >>> from zCLI.subsystems.zData.zData_modules.shared.backends import adapter_registry
    >>> # Adapters now available via AdapterFactory.create_adapter()
    >>> from zCLI.subsystems.zData.zData_modules.shared.backends.adapter_factory import AdapterFactory
...
def register_custom_adapter(data_type: str, adapter_class: Any) -> None:
    ...
    Example:
        >>> from zCLI.subsystems.zData.zData_modules.shared.backends.base_adapter import BaseDataAdapter
        >>> from zCLI.subsystems.zData.zData_modules.shared.backends.adapter_registry import register_custom_adapter
        >>> 
