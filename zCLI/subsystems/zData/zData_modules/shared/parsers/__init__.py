...
WHERE clause parsing:
    >>> from zCLI.subsystems.zData.zData_modules.shared.parsers import parse_where_clause
...
Value type parsing:
    >>> from zCLI.subsystems.zData.zData_modules.shared.parsers import parse_value
    >>> parse_value("42")
    42
    >>> parse_value("true")
    True
