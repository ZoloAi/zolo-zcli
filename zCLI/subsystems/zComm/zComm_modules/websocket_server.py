# zCLI/subsystems/zComm/zComm_modules/websocket_server.py
...
class zBifrost:
    def __init__(self, walker=None, zcli=None, logger, port: int = None, host: str = None):
        self.walker = walker
        self.zcli = zcli or (walker.zcli if walker else None)
        # Use provided logger (from zComm) or fallback to zCLI logger
        self.logger = logger
