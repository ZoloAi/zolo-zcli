...
------
```python
from zCLI.subsystems.zWizard.zWizard_modules import (
    WizardHat,
    interpolate_zhat,
...
from zCLI.subsystems.zWizard.zWizard_modules import wizard_hat
from zCLI.subsystems.zWizard.zWizard_modules import wizard_examples
```
