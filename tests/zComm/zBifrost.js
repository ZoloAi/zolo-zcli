/**
 * zBifrost.js - JavaScript WebSocket Client
 * 🌈 The rainbow bridge connecting web frontends to zCLI backend
 * 
 ...
 *   
 *   // CRUD operations
 *   const user = await client.create('Users', {name: 'Alice'});
 *   const users = await client.read('Users', {active: true});
